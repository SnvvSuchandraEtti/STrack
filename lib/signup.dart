...
import 'homescreeno.dart'; // Import your home screen
import 'login.dart'; // Import your login screen
import 'widgets.dart'; // Import your custom widgets
import 'navbar1.dart'; // Import your navigation bar if needed
      ...
      body: Container(
        decoration: const BoxDecoration(
          gradient: LinearGradient(
            colors: [Color(0xFFFFD5D5), Color(0xFFFFA07A)], // Use colors from the screenshot
                  ...
                  children: [
                    ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        backgroundColor: Colors.deepOrange, // Button color from screenshot
